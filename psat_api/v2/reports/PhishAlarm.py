...
class FilterOptions:
    ...
    def set_record_start_date(self, start_date: datetime) -> TFilterOptions:
        self.__options[self.__RECORD_START] = start_date
        return self

    def get_record_start_date(self) -> datetime:
        return self.__options[self.__RECORD_START]

    def set_record_end_date(self, start_date: datetime) -> TFilterOptions:
        self.__options[self.__RECORD_END] = start_date
        return self

    def get_record_end_date(self) -> datetime:
        return self.__options[self.__RECORD_END]

    def set_include_deleted_campaigns(self, enabled: bool) -> TFilterOptions:
        self.__options[self.__INCLUDE_DELETED_CAMPAIGNS] = enabled
        return self

    def get_include_deleted_campaigns(self):
        return self.__options[self.__INCLUDE_DELETED_CAMPAIGNS]
